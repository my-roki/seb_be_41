...
public class Q_07_boringBlackjack {
    public static void main(String[] args) {
        // write test case here
        Q_07_boringBlackjack coplit = new Q_07_boringBlackjack();

        int output = coplit.boringBlackjack(new int[]{1, 2, 3, 4});
        System.out.println(output); // 1

        output = coplit.boringBlackjack(new int[]{2, 3, 4, 8, 13});
        System.out.println(output); // 3
    }
